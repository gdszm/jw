...
@Service("referMaterialService")
public class ReferMaterialServiceImpl extends BaseServiceImpl implements ReferMaterialServiceI{
	...
	public FileData get(String id) throws Exception {
		...
		fileData.setDatatypeName(this.findDicName("MATERIALTYPE", fileData.getDatatype()));
