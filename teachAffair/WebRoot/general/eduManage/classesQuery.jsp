...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		...
		datagrid = $('#classesDatagrid').datagrid({
			url:"${pageContext.request.contextPath}/classes!datagridQuery.do",
        	width: 'auto',
			height:'auto',
			striped:true,
			nowrap:true,
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div id="win_classes_query" class="easyui-window" data-options="title:'查询设置',iconCls:'icon-search',modal:true,collapsible:false,maximizable:false,minimizable:false,closed:true" style="width:700px;height:300px;padding:5px;">
