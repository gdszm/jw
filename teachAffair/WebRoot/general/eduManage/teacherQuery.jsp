...
<script type="text/javascript" charset="utf-8">
	function initCombox(form){
		...
		initCombobox(form,'teacherType','${pageContext.request.contextPath}/dic!combox.do?ctype=NOTICETYPE');
	...
	$(function(){
		...
		datagrid = $('#teacherDatagrid').datagrid({
			url:"${pageContext.request.contextPath}/teacher!datagridQuery.do",
        	width: 'auto',
			height:'auto',
			striped:true,
			nowrap:true,
			...
			frozenColumns:[[
				...
				{field:'title',title:'教师标题',width:400,align:'center'}
				]],
			columns:[[
				//{field:'content',title:'教师内容',width:100,align:'center'},
				...
				{field:'teacherTypeName',title:'教师类型',width:100,align:'center'},
				...
				var p = dj.dialog({
					...
					onLoad : function() {
						...
						f.form('load', {
							...
							teacherType: rows[0].teacherType,
	...
	function cleanSearch() {
		...
		$('#teacherTypeId').combobox('setValue', '');
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div id="win_teacher_query" class="easyui-window" data-options="title:'查询设置',iconCls:'icon-search',modal:true,collapsible:false,maximizable:false,minimizable:false,closed:true" style="width:700px;height:300px;padding:5px;">
...
<!-- 					</tr> -->
					...
					<tr height="30">
						<td nowrap>教师类型 ：</td>
						<td colspan="3"> <input id="teacherTypeId"  name="teacherType" style="width:300px;"></td>
						<td/>
					</tr>
					<tr height="30">
						<td nowrap>创建日期 ：</td>
