...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		//提案列表
		tagrid.datagrid({
			url:'${pageContext.request.contextPath}/prop!queryAllDatagrid.do',
			width: 'auto',
			height:'auto',
			striped:true,
			nowrap:true,
			...
			columns:[[
				...
				{field:'webFlgName',title:'可否公开',align:'center',width:80,sortable:true},
				{field:'secondFlgName',title:'可否附议',align:'center',width:80,sortable:true},
