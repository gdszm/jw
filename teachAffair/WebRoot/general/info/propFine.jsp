...
<div data-options="region:'center',border:false" style="padding:3px;background:#fff;border:1px solid #ccc;">
	<center>
		<form id="fineForm" class="form-horizontal"  method="post">
		        ...
		        <td><table class="tableborder" id="formTable" sizset="false" >
		           <tbody sizset="false" >
		            ...
		            <tr height="25" sizset="false" >
		             ...
		             <tr height="25" sizset="false" >
		              <td height="25" width="80" nowrap="nowrap" class="tablelabel">优秀提案：</td>
		              <td height="25" colspan="3" class="tablecontent" sizset="false" align="left">
		              	<input id="excellentFlg" name="excellentFlg" data-options="editable:false" panelheight="auto" style="width:160px"/>
		              </td>
		            </tr>
		          </tbody>
		        </table></td>
