...
<div data-options="region:'center',border:false" style="padding:3px;background:#fff;border:1px solid #ccc;">
	<center>
		<form id="mergeForm" class="form-horizontal"  method="post">
		        ...
		        <td><table class="tableborder" id="formTable" sizset="false" >
		           <tbody sizset="false" >
		            ...
		            <tr height="25" sizset="false">
		              <td height="25" width="80" nowrap="nowrap" class="tablelabel">合并主提案：</td>
		              <td height="25" width="100%" class="tablecontent" sizset="false"><label id="mainProp" />  </td>
		            </tr>
					<tr height="25" sizset="false" >
		              <td height="25"　width="80" nowrap="nowrap" class="tablelabel">合并提案：</td>
		              <td  class="tablecontent">
		              	<textarea  id="mergeProp" readonly="readonly"　 style="width:99%;height:40px;padding:2px"></textarea>
		              </td>
		            </tr>
		            <tr height="25">
