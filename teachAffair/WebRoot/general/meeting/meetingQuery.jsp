...
<script type="text/javascript">
	...
	function initCombox(form){
		initCombobox(form,'status','${pageContext.request.contextPath}/dic!combox.do?ctype=MEETINGSTATUS');
	...
	$(document).ready(function() {
		...
		gridmeeting.datagrid({
			url:'${pageContext.request.contextPath}/meeting!queryDatagrid.do',
			width: 'auto',
			height:'auto',
			singleSelect:true,
			striped:true,
...
//		$("#meeting_queryForm input[name=status]").combobox('select', '请选择...');
		...
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',border:false" style="padding:10px;background:#fff;border:1px solid #ccc;">
				...
				<table id="meeting_queryTable">
					...
					<tr height="25">
						<td nowrap>发布时间：</td>
						<td> <input class="easyui-datebox" name="startDate"   style="width:134px"/>--<input class="easyui-datebox" name="endDate"  style="width:134px"/></td>
					</tr>
					<tr height="25">
						<td nowrap>承办单位：</td>
					...
					<tr height="25">
						<td nowrap>状态：</td>
						<td> <input id="status" name="status" panelHeight="100px" value="" style="width:280px;padding:2px;border:1px solid #000;"></td>
					</tr>
				</table>
				</form>
				</center>
