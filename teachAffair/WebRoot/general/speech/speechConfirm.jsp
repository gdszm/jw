...
$(document).ready(function() {
		//转弃方向
		$('#speechConfirmForm input[name=discardType]').combobox(
			{
		...
		//采用情况
		$('#speechConfirmForm input[name=useSituation]').combobox(
			{
		        ...
		        onSelect: function(record){
					if(record.cvalue=='3') {
						...
						$('#speechConfirmForm input[name=discardType]').val("");
					} else {
...
<center>
<form id="speechConfirmForm" class="form-horizontal"  method="post">
