...
<input type="hidden"  id="fromtype" name="fromtype" value="2" />
          ...
          <tbody  >
            ...
            <tr height="25"  >
             ...
             <tr height="25"  >
              ...
              <input type="text" id="key" name="key" class="easyui-validatebox"  value="${referMaterial.key}"  style="width:99.8%;" />
              </td>
            </tr>
              <tr height="25"  >
...
<%--			<a id="saveBtn" class="easyui-linkbutton" data-options="iconCls:'icon-save'" href="javascript:void(0)" onclick="saveReferMaterial()"> 保 存 </a>　--%>
<%--			<a id="submitBtn" class="easyui-linkbutton" data-options="iconCls:'icon-submit'" href="javascript:void(0)" onclick="javascript:submitReferMaterial()"> 提 交 </a>　--%>
