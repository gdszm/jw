          ...
          <tbody  >
			<tr height="30">
				<td height="45" colspan="4" align="middle" nowrap="nowrap"
					class="tablemain">
					<div align="center">
<!-- 						<strong>政协巴彦淖尔市sessionSeco.year年度通知公告</strong> -->
							<strong>公告修改</strong>
					</div></td>
			</tr>
			<tr height="25"  >
              <td height="25" width="80px" nowrap="nowrap" class="tablelabel">公告标题：</td>
              <td height="25" colspan="3" class="tablecontent"  align="left"><input type="text" id="title" name="title" class="easyui-validatebox" data-options="required:true" value="${notice.title}"  style="width:99%;padding:2px" /></td>
            </tr>
<%--            <tr height="25"  >--%>
