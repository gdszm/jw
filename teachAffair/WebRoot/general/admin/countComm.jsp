...
<script type="text/javascript">
	...
	$(document).ready(function(){  
		...
		gridoptions={
			...
			[
				{title:'数目',field:'value2',align:'right',width:80},
		...
		if(selectRows.length > 0){
			if (selectRows.length<6){
				for(var i=0; i<selectRows.length; i++){
					...
					columns2.push("{title:'数目',field:'value"+(i)+"',align:'right',width:80}");
					...
					<table id="formTable">
						<tr>
							...
							<form id="statItemForm" class="form-horizontal" action="/zxta/tjfx/blstat" method="post"></span><br/>
								<span><input id="ybtj_itemid1" name="id" style="height:19px;vertical-align:middle" type="radio" checked="checked" value="SEX"/><label for="ybtj_itemid1"> 按性别</label></span><br/>
								<span><input id="ybtj_itemid2" name="id" style="height:19px;vertical-align:middle" type="radio" value="CIRCLE"/><label for="ybtj_itemid2"> 按界别</label></span><br/>
								<span><input id="ybtj_itemid3" name="id" style="height:19px;vertical-align:middle" type="radio" value="NATION"/><label for="ybtj_itemid3"> 按民族</label></span><br/>
								<span><input id="ybtj_itemid4" name="id" style="height:19px;vertical-align:middle" type="radio" value="PARTY"/><label for="ybtj_itemid4"> 按党派</label></span><br/>
								<span><input id="ybtj_itemid6" name="id" style="height:19px;vertical-align:middle" type="radio" value="STATUS"/><label for="ybtj_itemid6"> 按状态</label></span><br/>
								<span><input id="ybtj_itemid7" name="id" style="height:19px;vertical-align:middle" type="radio" value="EDUCATION"/><label for="ybtj_itemid7"> 按学历</label></span><br/>
								<span><input id="ybtj_itemid8" name="id" style="height:19px;vertical-align:middle" type="radio" value="DEGREE"/><label for="ybtj_itemid8"> 按学位</label></span><br/>
								<span><input id="ybtj_itemid5" name="id" style="height:19px;vertical-align:middle" type="radio" value="GROUP"/><label for="ybtj_itemid5"> 按提案人分组</label></span><br/>
								<span><input id="ybtj_itemid9" name="id" style="height:19px;vertical-align:middle" type="radio" value="TAANREN"/><label for="ybtj_itemid9"> 提案人提交情况</label></span><br/>
								<span><input id="ybtj_itemid10" name="id" style="height:19px;vertical-align:middle" type="radio" value="WEIYUAN"/><label for="ybtj_itemid10"> 委员提交情况</label></span><br/>
							</form>
							</td>
						</tr>
					</table>
