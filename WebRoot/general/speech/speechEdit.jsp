            ...
            <tr height="25"  >
              <td height="25" width="140px" nowrap="nowrap" class="tablelabel">发言人：</td>
               <td height="25"  class="tablecontent"  align="left" width="40%">
	              	...
	              	<c:if test="${sessionInfo.userGroup==ug_wy}">
	              		<input id="nameId" name="name" value="${speech.name}"  class="easyui-validatebox" data-options="required:true" style="width:410px;" readonly="readonly" />
	              	</c:if>
	              	<c:if test="${sessionInfo.userGroup!=ug_wy}">
