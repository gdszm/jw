					...
					<table id="formTable">
						<tr>
							...
							<form id="statItemForm" class="form-horizontal" action="/zxta/tjfx/blstat" method="post"></span><br/>
								<span><input id="ybtj_itemid1" name="id" style="height:19px;vertical-align:middle" type="radio" checked="checked" value="SEX"/><label for="ybtj_itemid1"> 按性别统计</label></span><br/>
								<span><input id="ybtj_itemid2" name="id" style="height:19px;vertical-align:middle" type="radio" value="CIRCLE"/><label for="ybtj_itemid2"> 按界别统计</label></span><br/>
								<span><input id="ybtj_itemid3" name="id" style="height:19px;vertical-align:middle" type="radio" value="NATION"/><label for="ybtj_itemid3"> 按民族统计</label></span><br/>
								<span><input id="ybtj_itemid4" name="id" style="height:19px;vertical-align:middle" type="radio" value="PARTY"/><label for="ybtj_itemid4"> 按党派统计</label></span><br/>
							</form>
							</td>
						</tr>
					</table>
