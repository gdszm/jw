...
<div data-options="region:'center',border:false" style="padding:3px;background:#fff;border:1px solid #ccc;">
	<center>
	<form id="tacheckForm" class="form-horizontal" method="post">
	...
	<input type="hidden"  id="adviceUnit" name="adviceUnit" value="${obj.adviceUnit}"/>
	...
	<table style="width:1024px;" border="0" align="center" cellpadding="0" cellspacing="0">
	      <tr>
			...
			<tr  height="25" sizset="false">
              ...
              <td height="25"　 colspan="3" class="tablecontent" sizset="false" align="left" ><input id="undertakeUnit" name="undertakeUnit" value="${obj.undertakeUnit}"   style="width:99%;padding:2px" /></td>
              
            </tr>
            <tr height="25" sizset="false">
              <td height="25" width="80px" nowrap="nowrap" class="tablelabel">可否附议：</td>
              <td height="25" width="300px" class="tablecontent" sizset="false"  align="left"><input name="secondFlg" id="secondFlg" value="${obj.secondFlg}" data-options="required:true,editable:false,validType:'sel'" panelheight="auto" style="width:300px"/>
                 </td>
              ...
              <td height="25" width="300px" class="tablecontent" sizset="false"  align="left"><input name="webFlg" id="webFlg"  value="${obj.webFlg}" data-options="required:true,editable:false,validType:'sel'" panelheight="auto" style="width:300px"/>
           	...
           	<tr>
				<td colspan="4" align="center" class="tablecontent">
					<div class="easyui-tabs" style="width:1024px;height:520px;"> 
						<div title="&nbsp;&nbsp;提案内容&nbsp;&nbsp;" style="padding:3px;overflow:hidden" align="center">
							<script id="editor" type="text/plain" style="width:99%;height:370px;">${obj.content}</script>
						</div>
	            ...
	            <tr height="32" sizset="false">
	              <td height="25" align="center"　 colspan="4" nowrap="nowrap" class="tablemain">审查提案</td>
	            </tr>
	             <tr height="25" sizset="false" >
	              <td height="25" width="80px" nowrap="nowrap" class="tablelabel">是否立案：</td>
	              <td height="25" width="300px" class="tablecontent" sizset="false" ><input name="fileMethod" data-options="required:true,editable:false,validType:'sel'" id="fileMethod" value="${obj.fileMethod}"  panelheight="auto" style="width:300px"/>
	              </td>
	              <td height="25" width="80px" nowrap="nowrap" class="tablelabel">内容分类：</td>
	              <td height="25" width="300px" class="tablecontent" sizset="false" ><input name="propertiesType" id="propertiesType" data-options="editable:false" value="${obj.propertiesType}" panelheight="quto" style="width:300px">
	              <input type="hidden"  id="typeId" name="typeId" value="${obj.typeId}"/>
	              </td>
	            </tr>
	             <tr height="25" sizset="false" >
	              <td height="25" width="80px" nowrap="nowrap" class="tablelabel">建议办理方式：</td>
	              <td height="25" width="300px" colspan="3" class="tablecontent" sizset="false" ><input name="handleType" id="handleTypeCheck" data-options="editable:false"  value="${obj.handleType}" panelheight="auto" style="width:300px">
	                </td>
	            </tr>
	            <c:if test="${obj.fileMethod=='1'}">
	             <tr id="noFillingTr" height="100" sizset="false">
	            </c:if>
	            <c:if test="${obj.fileMethod!='1'}">
	            	 <tr id="noFillingTr" height="100" sizset="false" style="display:none">
	            </c:if>
		             <td height="25" width="80px" nowrap="nowrap" class="tablelabel">不立案原因：</td>
		              <td height="25" colspan="3" class="tablecontent" > 
		              	<textarea name="noFillingReason" id="noFillingReason" style="width:99%;height:100px;padding:2px">${obj.noFillingReason}</textarea>
		              </td>
	             </tr>
	             ...
	             <tr height="25" sizset="false" >
		              ...
		              <td height="25" width="300px" colspan="3" class="tablecontent" sizset="false" ><input name="analySisUnit" id="analySisUnit" data-options="editable:false" value="${obj.analySisUnit}" style="width:300px" />
	                  </td>
	            </tr>
	             <tr height="25" sizset="false" >
	              ...
	              <td height="25" width="300px" class="tablecontent" sizset="false" ><input type="text" name="checkTime" id="checkTime"  style="width:300px"/>
	              </td>
	            </tr>
	          </tbody>
	        </table></td>
