			...
			f.form('submit', {
				...
				success : function(d) {
					...
					if (json.success) {
						...
						//});
						alert(json.obj);
						alert(url+"/upload/mobile/"+json.obj);
						...
						<table class="tableborder" id="formTable">
							<tr height="40">
				              <td height="45" colspan="5" align="middle" nowrap="nowrap" class="tablemain" width="100%">
				               	<div align="center"><strong>学生档案新增</strong></div>
				              </td>
				            </tr>
...
<div id="win_ee_query" class="easyui-window" data-options="title:'添加家庭成员',iconCls:'icon-search',modal:true,collapsible:false,maximizable:false,minimizable:false,closed:true" style="width:650px;height:320px;padding:5px;">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding:10px;background:#fff;border:1px solid #ccc;">
			<center>
...
<div id="win_we_query" class="easyui-window" data-options="title:'添加家庭成员',iconCls:'icon-search',modal:true,collapsible:false,maximizable:false,minimizable:false,closed:true" style="width:650px;height:320px;padding:5px;">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding:10px;background:#fff;border:1px solid #ccc;">
			<center>
