...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		...
		datagrid = $('#noticeDatagrid').datagrid({
			url:"${pageContext.request.contextPath}/notice!datagridQuery.do",
        	width: 'auto',
			height:'auto',
			striped:true,
			nowrap:true,
			...
			frozenColumns:[[
				...
				{field:'title',title:'考试标题',width:400,align:'center'}
				]],
			columns:[[
				//{field:'content',title:'考试内容',width:100,align:'center'},
				...
				{field:'noticeTypeName',title:'考试类型',width:100,align:'center'},
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div id="win_notice_query" class="easyui-window" data-options="title:'查询设置',iconCls:'icon-search',modal:true,collapsible:false,maximizable:false,minimizable:false,closed:true" style="width:700px;height:300px;padding:5px;">
...
<!-- 					</tr> -->
					...
					<tr height="30">
						<td nowrap>考试类型 ：</td>
						<td colspan="3"> <input id="noticeTypeId"  name="noticeType" style="width:300px;"></td>
						<td/>
					</tr>
					<tr height="30">
						<td nowrap>创建日期 ：</td>
