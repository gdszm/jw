...
<script type="text/javascript">
	...
	$(document).ready(function(){  
		...
		$.ajax({
			url :'${pageContext.request.contextPath}/activitypeo!getColumns.do',
			success : function(data) {
		        ...
		        $('#griddata').datagrid({
					width: '100%',
					height:'100%',
					url:'${pageContext.request.contextPath}/activitypeo!situationCount.do',
					fit:true,
					rownumbers:true,
					singleSelect:true,
					striped:true,
		...
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',border:false" style="padding:10px;background:#fff;border:1px solid #ccc;">
				...
				<table id=tableForm>				
					...
					<tr height="30">
						<td nowrap>性别：</td>
						<td align="left" ><input id="sex" name="sex" style="width:157px;padding:2px" /></td>
						<td nowrap>民族：</td>
						<td align="left"><input id="nation"  name="nation" style="width:157px;padding:2px" /></td>
					</tr>
					<tr height="30">
						<td nowrap>党派：</td>
						<td align="left"><input id="partyCode"  name="partyCode" style="width:157px;padding:2px" /></td>
						<td nowrap>界别：</td>
						<td align="left"><input id="circleCode"  name="circleCode" style="width:157px;padding:2px" /></td>
					</tr>
					<tr height="30">
						<td nowrap>专委会：</td>
						<td align="left" colspan="3" ><input id="committee"  name="committee" style="width:157px;padding:2px" /></td>
					</tr>
				</table>
				</form>
				</center>
