...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/easyui-modern/css/base.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/easyui-modern/css/process.css">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/easyui-modern/uimaker/easyui.css">
<!-- <link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/jquery-easyui-1.3.6/themes/icon.css" type="text/css"></link> -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/easyui-modern/uimaker/icon.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/jquery-easyui-1.3.6/locale/easyui-lang-zh_CN.js" charset="utf-8"></script><!-- easyui插件库 -->
<!-- easyui插件库 -->
